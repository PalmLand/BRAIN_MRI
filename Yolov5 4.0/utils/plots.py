...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if 'Occlusion' in label:
        color = [255,48,155]# Purple1
    elif 'Moderate stenosis' in label:
        color = [0,0,255]# MediumBlue
    elif 'Severe stenosis' in label:
        color = [255,0,0]# red
    elif 'Absence of signal' in label:
        color = [11,134,184]# DarkGoldenrod
