...
def convert(anno_path, xml_dir, json_file):
    ...
    json_dict['info'] = {'version': '1.0', 'year': 2017, 'contributor': 'Guanru Tan', 'date_created': '2021/03/29'}
...
if __name__ == '__main__':
    ...
    for i in folder_list:
        ...
        # anno_path：存放VOC annotaions的路径
        # name_dir：存放文件名的txt路径
        # json_dir： 存放COCO json文件的路径
